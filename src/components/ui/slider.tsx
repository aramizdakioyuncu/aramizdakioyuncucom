...
export function Slider({ slides = defaultSlides, durationTime = 5000 }: SliderProps) {
  ...
  }, [slides, durationTime, currentIndex]); // Dependency includes currentIndex to reset interval when user clicks
        ...
        <div className="flex gap-3 w-full">
          {slides.map((_, index) => (
            ...
            >
              {index === currentIndex && (
                <div 
                  key={`progress-${currentIndex}`} // Force re-render of animation
