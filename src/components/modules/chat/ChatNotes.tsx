  ...
  return (
    <div className="flex flex-col items-center shrink-0 cursor-pointer group relative">
      <div className="relative mb-3 flex flex-col items-center">
        ...
        {/* Thought Bubble Box */}
        <div className={`relative px-3 py-1.5 rounded-2xl text-[10px] font-bold max-w-[85px] transition-all group-hover:-translate-y-1 shadow-sm border border-black/5 dark:border-white/10 ${
          note.isMe 
