                           ...
                           <div className="grid grid-cols-2 gap-3">
                              {Object.values(roles).map(r => (
                                 <button
                                    ...
                                    className={`p-5 rounded-3xl border text-left transition-all group relative overflow-hidden ${newRole === r.id ? 'border-blue-500 bg-blue-500/10 shadow-lg shadow-blue-500/10' : 'border-white/5 bg-black/5 hover:border-white/30'
                                       }`}
                                 >
                        ...
                        <div className="space-y-6 text-left animate-in zoom-in duration-300">
                           ...
                           <div className="grid grid-cols-1 gap-3 max-h-[300px] overflow-y-auto pr-2 custom-scrollbar">
                              {PUNISHMENT_RULES.map(rule => (
                                 <button
                                    ...
                                    className={`p-5 rounded-3xl border text-left transition-all relative overflow-hidden group ${selectedRule?.id === rule.id ? 'border-blue-500 bg-blue-500/10 shadow-lg shadow-blue-500/10' : 'border-white/5 bg-black/5 hover:border-white/20'
                                       }`}
                                 >
                                    <div className="flex justify-between items-start mb-2">
                                       ...
                                       <div className={`text-[9px] font-black px-3 py-1 rounded-full uppercase tracking-widest ${rule.severity === 'critical' ? 'bg-red-600 text-white animate-pulse' :
                           ...
                           <div className="space-y-4 text-left">
                              ...
                              <button
                                 ...
                                 className={`w-full py-6 font-black rounded-[28px] text-[13px] uppercase tracking-[0.2em] shadow-2xl active:scale-95 transition-all flex items-center justify-center gap-3 group ${selectedRule
