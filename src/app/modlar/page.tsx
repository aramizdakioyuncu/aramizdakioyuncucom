            ...
            {viewMode === 'grid' ? (
              ...
              <div className="glass-panel overflow-hidden rounded-[32px] border border-armoyu-card-border shadow-2xl animate-in fade-in slide-in-from-right-8 duration-500">
                ...
                <div className="divide-y divide-black/5 dark:divide-white/5">
                  {MODS.map((mod) => (
                    <div key={mod.id} className="grid grid-cols-1 md:grid-cols-12 gap-4 px-8 py-5 items-center hover:bg-blue-600/5 transition-all group">
                      ...
                      <div className="col-span-4">
                        ...
                        <p className="text-[10px] text-armoyu-text-muted font-bold mt-1 uppercase">Yapımcı: {mod.author}</p>
                      </div>
