           ...
           <div className="animate-in fade-in duration-500 max-w-6xl mx-auto flex flex-col lg:flex-row gap-8">
              ...
              <div className="flex-1 space-y-6">
                 ...
                 <div className="flex flex-col gap-3">
                    {/* Real Page Preview Button Concept */}
                    {editingId && (
                       <a 
                         href={`/haberler/preview-${editingId}?preview=true`} 
                         target="_blank" 
                         rel="noopener noreferrer"
                         className="w-full py-4 text-[10px] font-black uppercase tracking-widest bg-blue-600 hover:bg-blue-500 text-white rounded-xl shadow-xl shadow-blue-500/20 transition-all flex items-center justify-center gap-2 mb-2"
                       >
                         <Eye size={14} /> Tam Sayfada Önizle
                       </a>
                    )}
