...
export default function SchoolDetailPage({ params }: SchoolDetailPageProps) {
  ...
  const school = (schoolList || []).find(s => s.slug === slug);
       ...
       <div className="max-w-[1280px] mx-auto px-6 md:px-12 mt-12">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
             ...
             <div className="lg:col-span-9 space-y-12">
                            ...
                            <div className="relative z-10">
                               ...
                               <p className="text-xs font-medium text-armoyu-text-muted uppercase tracking-widest leading-relaxed mb-8">
                                ...
                                <div className="space-y-3">
                                   {(school.classrooms || []).slice(0, 2).map((c, i) => (
                ...
                {activeTab === 'Sınıflar' && (
                   <div className="space-y-8 animate-in fade-in slide-in-from-bottom-2 duration-500">
                      <div className="flex items-center justify-between mb-8 bg-black/5 dark:bg-white/5 p-8 rounded-[40px] border border-armoyu-card-border">
                          <div>
                             <h3 className="text-xl font-black text-armoyu-text uppercase italic mb-2 tracking-tighter leading-none">ÇALIŞMA SINIFLARI</h3>
                             <p className="text-[11px] font-bold text-armoyu-text-muted uppercase tracking-widest opacity-60">Sınıf şifresini temsilcinden veya öğretmeninden alabilirsin.</p>
                          </div>
                      </div>
