...
import { PageWidth, BackToStore, useCart } from '@armoyu/ui';
  ...
  return (
    <div className="pb-32 animate-in fade-in duration-1000">
      ...
      {cart.length > 0 ? (
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
          ...
          <div className="lg:col-span-4 space-y-8">
            <div className="glass-panel p-10 rounded-[56px] border border-armoyu-card-border bg-armoyu-card-bg shadow-2xl shadow-blue-500/10 relative overflow-hidden">
              ...
              <Link href="/magaza/odeme" className="group relative w-full py-6 bg-blue-600 hover:bg-blue-500 text-white font-black text-xs uppercase tracking-[0.2em] rounded-[24px] transition-all shadow-2xl shadow-blue-500/20 text-center block active:scale-95 overflow-hidden">
        ...
        <div className="text-center py-40 glass-panel rounded-[80px] border border-dashed border-armoyu-card-border animate-in fade-in zoom-in-95 duration-700">
           <div className="group relative w-32 h-32 bg-blue-600/5 rounded-[40px] flex items-center justify-center mx-auto text-blue-600 mb-10 overflow-hidden">
              <div className="absolute inset-0 bg-blue-600/10 blur-2xl opacity-0 group-hover:opacity-100 transition-opacity" />
              <ShoppingBag size={56} className="relative z-10 group-hover:scale-110 transition-transform duration-700" strokeWidth={1.5} />
           </div>
           <div className="mb-12">
             <h2 className="text-4xl md:text-6xl font-black text-armoyu-text uppercase tracking-tighter italic mb-4">SEPETİN ŞU AN BOŞ</h2>
             <p className="text-armoyu-text-muted text-lg font-medium max-w-sm mx-auto opacity-70">Henüz sepetine bir şey eklemedin. Mağaza sayfamızda harika ürünler seni bekliyor!</p>
           </div>
           <Link href="/magaza" className="group relative inline-flex items-center gap-4 px-16 py-6 bg-blue-600 hover:bg-blue-500 text-white font-black text-xs uppercase tracking-[0.3em] rounded-3xl transition-all shadow-2xl shadow-blue-500/20 active:scale-95 overflow-hidden">
             <span className="relative z-10">ALIVERİŞE BAŞLA</span>
