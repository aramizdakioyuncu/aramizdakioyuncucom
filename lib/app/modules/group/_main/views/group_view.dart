...
class GroupView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return BodyWidget.custom1(context, transparentBody: true, body: [
      Obx(
        () => Wrap(
          children: [
            ...List.generate(
              ...
              (index) {
                APIGroupListDetail groupInfo = controller.groupList[index];
                return Padding(
                        ...
                        Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              InkWell(
                                onTap: () {
                                  Get.toNamed("/gruplar/${groupInfo.groupURL}");
                                },
                                child: CircleAvatar(
                              ...
                              children: [
                                SizedBox(
                                  ...
                                  child: Padding(
                                    ...
                                    child: Visibility(
                                      visible: groupInfo.description != null,
                                      child: Text(
                                ...
                                ListTile(
                                  ...
                                  title: Visibility(
                                    visible: groupInfo.socail.website != null,
                                    child: Text(
                                      groupInfo.socail.website.toString(),
                                      style: const TextStyle(
                                        fontWeight: FontWeight.bold,
                                      ),
                                    ),
                                ...
                                ListTile(
                                  ...
                                  title: Visibility(
                                    visible: groupInfo.defaultgame != null,
                                    child: Text(
                                      groupInfo.defaultgame.toString(),
                                      style: const TextStyle(
                                        fontWeight: FontWeight.bold,
                                      ),
                                    ),
