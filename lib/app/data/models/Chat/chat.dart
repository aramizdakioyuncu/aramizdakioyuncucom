import 'package:aramizdakioyuncucom/app/data/models/Chat/chat_message.dart';
import 'package:aramizdakioyuncucom/app/data/models/user.dart';
import 'package:aramizdakioyuncucom/app/data/models/useraccounts.dart';
...
class Chat {
  ...
  Widget listtilechat(context, {required UserAccounts currentUserAccounts}) {
    return ListTile(
      ...
      title: Text(user.displayName!.value),
