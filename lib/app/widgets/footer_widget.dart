...
class FooterWidget {
  static Widget custom(BuildContext context) {
    return Align(
                          ...
                          (index) {
                            return InkWell(
                              ...
                              child: Padding(
                                ...
                                child: CachedNetworkImage(
                                  imageUrl:
                                      Applist.footersocailnetwork[index + 3],
                                  height: 60,
                                  width: 60,
                                ),
                              ),
                    ...
                    const Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            "Konserde çok güzel eğlenildi ödülleri verildi...",
                            textAlign: TextAlign.justify,
                            style: TextStyle(
                              fontSize: 10,
                              color: Colors.white,
                      ...
                      (index) {
                        return InkWell(
                          ...
                          child: Padding(
                            padding: const EdgeInsets.all(28.0),
                            child: CachedNetworkImage(
                              imageUrl: Applist.footersocailnetwork[index + 3],
                              height: 60,
                              width: 60,
                            ),
                          ),
